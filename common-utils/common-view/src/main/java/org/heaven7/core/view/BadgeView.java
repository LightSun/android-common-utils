...
public class BadgeView extends TextView {
	...
	public static class Builder{
		...
		public Builder(BadgeView view) {
			this.view = view;
		}

		public Builder setBadgeBackgroundColor(int color){
			view.setBadgeBackgroundColor(color);
			return this;
		}
		public Builder setBadgeBackgroundColorRes(int colorId){
			setBadgeBackgroundColor(view.getContext().getResources().getColor(colorId));
			return this;
		}

		public Builder setNumberText(int number){
			view.setText(number + "");
			return this;
		}
		public Builder increase(int offset){
			view.increment(offset);
			return this;
		}
		...
		public Builder setTextColorRes(int colorId){
		...
		public Builder setBadgePosition(int position){
			view.setBadgePosition(position);
			return this;
		}
		public void show(Animation anim){
			view.show(anim);

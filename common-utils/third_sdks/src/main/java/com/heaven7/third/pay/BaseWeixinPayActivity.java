 ...
 */
public abstract class BaseWeixinPayActivity extends AppCompatActivity {

    private WeixinPayHelper mWeiXinHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeiXinHelper = SdkFactory.getWeixinPayHelper(this);
